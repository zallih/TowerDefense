...
import com.ltztec.entities.PlantControl;
...
public class Game extends Canvas implements Runnable,KeyListener,MouseListener,MouseMotionListener{
	...
	public Game(){
		...
		ui = new UI();
		plantControl = new PlantControl(0, 0, 0, 0, 0, null);
	...
	public void mousePressed(MouseEvent e) {
		plantControl.isPressed = true;
		plantControl.xTarget = e.getX() / 3;
		plantControl.yTarget = e.getY() / 3;
